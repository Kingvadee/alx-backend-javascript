...
Use `npm install --save-dev mocha` to install mocha
When you successfully install mocha npm creats a lockfile as package-lock.json. You should commit the file.
